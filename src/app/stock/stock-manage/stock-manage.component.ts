...
export class StockManageComponent implements OnInit {
  ...
  ngOnInit() {
    this.stocks = [
      ...
      new Stock(3, '第三只股票', 3.99, 3, '这是第三只股票,是我在学习慕课网Angular入门实战时创建的', ['IT']),
      new Stock(4, '第四只股票', 4.99, 5, '这是第四只股票,是我在学习慕课网Angular入门实战时创建的', ['互联网']),
      new Stock(5, '第五只股票', 5.99, 2, '这是第五只股票,是我在学习慕课网Angular入门实战时创建的', ['IT', '互联网']),
      new Stock(6, '第六只股票', 6.99, 4, '这是第六只股票,是我在学习慕课网Angular入门实战时创建的', ['金融']),
